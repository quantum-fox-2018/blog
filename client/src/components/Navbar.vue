<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand"><router-link :to="{ path: '/', params: { id: '' } }">Zena's Blog</router-link></a>
...
export default {
  ...
  methods: {
    ...
    register: function () {
      axios.post('http://35.197.139.113/register', {
        email: this.email,
    ...
    login: function () {
      axios.post('http://35.197.139.113/login', {
